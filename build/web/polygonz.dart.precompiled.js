...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"Lp","call$2","call$1","gbY",2,2,12,13],
$isvs:true,
$isb8:true,
...
v.$builtinTypeInfo=[H.Kp(z,0)]
z=v.u7
if(z!=null&&v.VP<=0)J.qV(v.uv,x,z,w)}},"call$0","eE",0,0,1],
...
if(j>=s)return H.e(k,j)
k[j]=[(l+q*(0.5-p))*h,(i+g*(0.5-f))*e]}++i;++j}m.push(k);++l;++n}d=document.getElementById("canvas")
s=J.RE(d)
s.sR(d,$.h6)
s.sfg(d,$.JC)
G.x3(m)},
...
if(C.jn.Y(y,2)===1)if(C.jn.Y(w,2)===1){t=y-(x?0:1)
...
v.moveTo(r-y,t[q][1]-w)
if(y>=a.length)return H.e(a,y)
q=a[y]
if(w>=q.length)return H.e(q,w)
q=q[w]
v.lineTo(q[0]-y,q[1]-w)
t=$.Rr
...
v.lineTo(r-y,s[q][1]-w)}else{t=y-(x?0:1)
s=a.length
if(t<0||t>=s)return H.e(a,t)
t=a[t]
...
v.moveTo(t-y,r[w][1]-w)
if(y>=a.length)return H.e(a,y)
r=a[y]
t=w+1
if(t>=r.length)return H.e(r,t)
t=r[t]
v.lineTo(t[0]-y,t[1]-w)
t=$.Rr
if(typeof t!=="number")return H.s(t)
t=y>=t
s=y+(t?0:1)
...
q=a[q]
if(w>=q.length)return H.e(q,w)
v.lineTo(s-y,q[w][1]-w)}else if(C.jn.Y(w,2)===1){t=y-(x?0:1)
s=a.length
if(t<0||t>=s)return H.e(a,t)
t=a[t]
if(w>=t.length)return H.e(t,w)
...
q=a[q]
if(w>=q.length)return H.e(q,w)
v.lineTo(s-y,q[w][1]-w)}else{t=y-(x?0:1)
s=a.length
if(t<0||t>=s)return H.e(a,t)
t=a[t]
r=w+1
...
v.lineTo(s-y,p[r][1]-w)}v.closePath()
v.fill()
...
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Vv",ret:J.kn,args:[W.cv,J.O,J.O,W.JQ]},{func:"WW",void:true,args:[W.ea]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"KV",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"YI",void:true,args:[P.a]},{func:"qu",void:true,args:[W.KV]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
Lb.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,P2,nB,i3,it,QP,IF,n6,Ny,Kh,TK,Y5,Gc,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,BK,ae,cv,Fs,Ty,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,PP,Qb,PG,xe,Hw,bn,Ik,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,u2,bX,lr,MC,iQ,Ue,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,YS,y6,RH,Kn,Lq,w6,BR,vw,aG,fA,Oi,UM,hq,WS,NL,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,pQ,um,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,jr,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Dc,Sl,Qm,ET,V6,FK,Gv,kn,YE,MF,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,ZQ,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,Eq,lb,tD,hJ,dC,wN,VX,aL,a7,i1,xy,MH,A8,U5,SO,SU,Ca,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,W0,Sw,o0,CL,iP,Hn,Zl,UT,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,oe,kM,An,c8,a,mE,Rn,wv,M0,VG,Cv,zL,ec,e7,dx,kE,hm,x5,cf,i7,I2,RO,eu,xC,JQ,Pb,vD,mD,Eg,m6,ct,IA,Ow,W9,dW,rB,kF,mk,MM,fm,IU,mg,b0,Pg,Ob,GV,D7,Zf,GS,em,Lb]}