...
"%":"CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"},
kn:{
"^":"bool/Gv;",
...
x=this.aL
w=z.call$1(x?H.o2(this).getUTCMonth()+1:H.o2(this).getMonth()+1)
v=z.call$1(x?H.o2(this).getUTCDate()+0:H.o2(this).getDate()+0)
u=z.call$1(x?H.o2(this).getUTCHours()+0:H.o2(this).getHours()+0)
t=z.call$1(x?H.o2(this).getUTCMinutes()+0:H.o2(this).getMinutes()+0)
s=z.call$1(x?H.o2(this).getUTCSeconds()+0:H.o2(this).getSeconds()+0)
z=x?H.o2(this).getUTCMilliseconds()+0:H.o2(this).getMilliseconds()+0
r=new P.Zl().call$1(z)
if(x)return H.d(y)+"-"+H.d(w)+"-"+H.d(v)+" "+H.d(u)+":"+H.d(t)+":"+H.d(s)+"."+H.d(r)+"Z"
else return H.d(y)+"-"+H.d(w)+"-"+H.d(v)+" "+H.d(u)+":"+H.d(t)+":"+H.d(s)+"."+H.d(r)},
EK:function(){H.o2(this)},
$isiP:true,
static:{"^":"Oj,Vp,df,yz,ch,QC,Px,Yp,kc,Gi,k3,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk"}},
Hn:{
"^":"Tp:18;",
...
$isa6:true,
static:{"^":"Wt,S4,dk,Lo,z2,b2,q9,Ie,Do,Pu,kT,IJ,D9,Vk,S8,rG",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:18;",
...
GS:{
"^":"Tp:10;",
call$1:function(a){return J.Mp(a)}}}],["","file:///Users/zachnagengast09/Drive/Web/polygonz/web/polygonz.dart",,G,{
"^":"",
Iq:[function(){var z,y,x,w,v
G.V3()
z=J.Vg(document.querySelector("#update"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new G.em()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#save"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new G.Lb()),z.Sg),[H.Kp(z,0)]).Zz()
for(y=0;$.ru(),y<21;++y){z="#swatch-"+y
z=J.Vg(document.querySelector(z))
x=z.Ph
w=z.Sg
v=new W.xC(0,z.uv,x,W.VF(G.YA()),w)
v.$builtinTypeInfo=[H.Kp(z,0)]
z=v.u7
if(z!=null&&v.VP<=0)J.qV(v.uv,x,z,w)}for(y=0;$.cq(),y<8;++y){z="#preset-"+y
z=J.Vg(document.querySelector(z))
x=z.Ph
w=z.Sg
v=new W.xC(0,z.uv,x,W.VF(G.iM()),w)
v.$builtinTypeInfo=[H.Kp(z,0)]
z=v.u7
if(z!=null&&v.VP<=0)J.qV(v.uv,x,z,w)}z=H.VM(new W.RO(window,C.Z4.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new G.QA()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","eE",0,0,1],
V3:function(){var z,y,x,w
J.Qy(document.querySelector("#colors-dropdown"),"")
for(z=0;$.ru(),z<21;++z){y=document.querySelector("#colors-dropdown")
x=J.RE(y)
x.shf(y,J.WB(x.ghf(y),"<li><a href=\"\" id=\"swatch-"+z+"\">"+$.ru()[z]+"</a></li>"))}document.getElementById("presets-dropdown")
J.Qy(document.querySelector("#presets-dropdown"),"")
for(z=0;$.cq(),z<8;++z){y=document.querySelector("#presets-dropdown")
x=J.RE(y)
x.shf(y,J.WB(x.ghf(y),"<li><a href=\"\" id=\"preset-"+z+"\">"+$.cq()[z]+"</a></li>"))}y=new P.iP(Date.now(),!1)
y.EK()
w=H.tJ(y)
J.Qy(document.querySelector("#footer"),"&copy; "+w+" Zauce Technologies")
G.dI()},
dI:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d
z=document.getElementById("width")
y=document.getElementById("height")
x=document.getElementById("densityX")
w=document.getElementById("densityY")
v=document.getElementById("slider")
u=document.getElementById("wrap")
t=J.Vm(document.getElementById("colors"))
s=J.RE(z)
$.h6=H.Hp(s.gP(z),null,null)
r=J.RE(y)
$.JC=H.Hp(r.gP(y),null,null)
q=J.RE(x)
if(J.xZ(H.Hp(q.gP(x),null,null),$.j2))q.sP(x,$.j2)
p=J.RE(w)
if(J.xZ(H.Hp(p.gP(w),null,null),$.j2))p.sP(w,$.j2)
if(J.xZ(H.Hp(s.gP(z),null,null),$.Ln))s.sP(z,$.Ln)
if(J.xZ(H.Hp(r.gP(y),null,null),$.Ln))r.sP(y,$.Ln)
$.Rr=H.Hp(q.gP(x),null,null)
$.QL=H.Hp(p.gP(w),null,null)
s=H.Hp(J.Vm(v),null,null)
if(typeof s!=="number")return s.V()
$.Z2=s/10
$.OI=J.S6(u)
$.MY=[]
for(s=J.U6(t),r=t.length,o=-1,n=0;n<s.gB(t);++n){if(n>=r)return H.e(t,n)
if(C.xB.OY("0123456789abcdefABCDEF",t[n])>-1){q=$.It()
if(o<0||o>=q.length)return H.e(q,o)
q[o]=q[o]+t[n]}if(t[n]==="#"){++o
$.It().push("#")}}s=$.h6
r=$.Rr
if(typeof s!=="number")return s.V()
...
q=n>=p||j<1||j>=q-1}else q=!0
if(q){q=$.cc
if(typeof q!=="number")return H.s(q)
p=$.Tl
if(typeof p!=="number")return H.s(p)
if(j>=s)return H.e(k,j)
k[j]=[l*q,i*p]}else{q=$.Z2
p=C.pr.w7()
...
if(j>=s)return H.e(k,j)
k[j]=[(l+q*(0.5-p))*h,(i+g*(0.5-f))*e]}++i;++j}m.push(k);++l;++n}d=H.Go(document.querySelector("#canvas"),"$isNy")
d.width=$.h6
d.height=$.JC
G.x3(m)},
...
u=y*v
t=w*v
s=C.ON.yu(C.pr.w7()*$.It().length)
v=$.H9()
r=$.It()
if(s<0||s>=r.length)return H.e(r,s)
v.fillStyle=r[s]
if($.OI===!0)if(y===$.Rr){if(w>=z.length)return H.e(z,w)
v.fillStyle=z[w]}v.beginPath()
if(C.jn.Y(y,2)===1)if(C.jn.Y(w,2)===1){r=y-(x?0:1)
...
v.moveTo(p-u,r[o][1]-t)
if(y>=a.length)return H.e(a,y)
o=a[y]
if(w>=o.length)return H.e(o,w)
o=o[w]
v.lineTo(o[0]-u,o[1]-t)
r=$.Rr
if(typeof r!=="number")return H.s(r)
q=y+(y>=r?0:1)
...
v.lineTo(p-u,q[o][1]-t)}else{r=y-(x?0:1)
q=a.length
...
r=r[w][0]
p=y-(x?0:1)
if(p<0||p>=q)return H.e(a,p)
p=a[p]
if(w>=p.length)return H.e(p,w)
v.moveTo(r-u,p[w][1]-t)
if(y>=a.length)return H.e(a,y)
p=a[y]
r=w+1
if(r>=p.length)return H.e(p,r)
r=p[r]
v.lineTo(r[0]-u,r[1]-t)
r=$.Rr
if(typeof r!=="number")return H.s(r)
r=y>=r
q=y+(r?0:1)
...
q=q[w][0]
o=y+(r?0:1)
if(o>=p)return H.e(a,o)
o=a[o]
if(w>=o.length)return H.e(o,w)
v.lineTo(q-u,o[w][1]-t)}else if(C.jn.Y(w,2)===1){r=y-(x?0:1)
q=a.length
if(r<0||r>=q)return H.e(a,r)
r=a[r]
if(w>=r.length)return H.e(r,w)
...
o=a[o]
if(w>=o.length)return H.e(o,w)
v.lineTo(q-u,o[w][1]-t)}else{r=y-(x?0:1)
q=a.length
if(r<0||r>=q)return H.e(a,r)
r=a[r]
p=w+1
...
r=r[p][0]
o=y-(x?0:1)
if(o<0||o>=q)return H.e(a,o)
o=a[o]
if(p>=o.length)return H.e(o,p)
v.moveTo(r-u,o[p][1]-t)
if(y>=a.length)return H.e(a,y)
o=a[y]
if(w>=o.length)return H.e(o,w)
o=o[w]
...
q=q[p][0]
n=y+(r?0:1)
if(n>=o)return H.e(a,n)
n=a[n]
if(p>=n.length)return H.e(n,p)
v.lineTo(q-u,n[p][1]-t)}v.closePath()
v.fill()
if(x)z.push(v.fillStyle);++w}++y}P.JS("Updarted")},
zj:[function(a){var z,y,x,w
z=J.BC(a)
a.preventDefault()
y=J.RE(z)
J.Qy(document.getElementById("color-selector"),J.WB(y.ghf(z)," <span class=\"caret\">"))
x=document.getElementById("colors")
w=$.p2()
y=G.rz(y.ghf(z),$.ru())
if(y<0||y>=21)return H.e(w,y)
J.Fc(x,w[y])
G.dI()},"call$1","YA",2,0,7],
...
w=J.RE(z)
v=G.rz(w.ghf(z),$.cq())
if(v<0||v>=8)return H.e(x,v)
J.Fc(y,x[v][0])
v=document.getElementById("height")
x=$.YN()
y=G.rz(w.ghf(z),$.cq())
if(y<0||y>=8)return H.e(x,y)
J.Fc(v,x[y][1])
y=document.getElementById("densityX")
x=$.YN()
v=G.rz(w.ghf(z),$.cq())
if(v<0||v>=8)return H.e(x,v)
J.Fc(y,x[v][2])
v=document.getElementById("densityY")
x=$.YN()
y=G.rz(w.ghf(z),$.cq())
if(y<0||y>=8)return H.e(x,y)
J.Fc(v,x[y][3])
y=document.getElementById("presets")
x=$.cq()
w=G.rz(w.ghf(z),$.cq())
if(w<0||w>=8)return H.e(x,w)
J.Qy(y,x[w]+" <span class=\"caret\"></span>")
G.dI()},"call$1","iM",2,0,7],
rz:function(a,b){var z,y
for(z=b.length,y=0;y<z;++y)if(b[y]===a)return y
return-1},
em:{
"^":"Tp:10;",
call$1:function(a){return G.dI()}},
Lb:{
"^":"Tp:10;",
call$1:function(a){var z,y,x
z=document.getElementById("canvas")
y=document.getElementById("save")
x=J.RE(y)
x.shf(y,C.xB.g(J.WB(x.ghf(y),"<img src=\""),J.UP(z,"image/png"))+"\" style=\"display:none\">")
x.sLU(y,z.toDataURL("image/png",null))
return}},
QA:{
"^":"Tp:21;",
call$1:function(a){if(J.Zm(a)===13)G.dI()}}},1],])
...
I.$lazy($,"colors","MY","It",function(){return[""]})
I.$lazy($,"presetNames","oQ","cq",function(){return["iPhone 5","1080p","iPhone 4","iPad","4K","2.5k","720p","Web Tile"]})
I.$lazy($,"presetValues","yI","YN",function(){return[["640","1136","10","14"],["1920","1080","30","14"],["640","960","10","12"],["2048","1536","34","20"],["3840","2160","60","24"],["2560","1440","40","18"],["1280","720","20","10"],["200","200","12","12"]]})
I.$lazy($,"swatchNames","yL","ru",function(){return["Darkness","Heavy Cream","Attack of the Mac","Barcelona","Blue Humans","Buried at the Beach","Raptorize","Cthulhu Rises","Boring Volcano","Light the Sky","Hackers","Tracert","City by Night","Wicked Witch","Flying Monkeys","Searching","Office Chair in the Clouds","Born to be a Winner","1969","Teapots","Wordpress"]})
I.$lazy($,"swatchValues","i8","p2",function(){return["#444,#000,#040404,#080808,#0c0c0c,#101010,#141414,#181818,#1c1c1c,#202020,#242424,#282828,#2c2c2c,#000,#040404,#080808,#0c0c0c,#101010,#141414,#181818,#1c1c1c,#202020,#242424,#282828,#2c2c2c,#000,#040404,#080808,#0c0c0c,#101010,#141414,#181818,#1c1c1c,#202020,#242424,#282828,#2c2c2c","#fff,#faf9f8,#f7f7f6,#f6f5f4,#f4f3f2,#f2f1f0,#eeedec,#eae9e8,#faf9f8,#f7f7f6,#f6f5f4,#f4f3f2,#f2f1f0,#eeedec,#eae9e8,#faf9f8,#f7f7f6,#f6f5f4,#f4f3f2,#f2f1f0,#eeedec,#eae9e8","#445555,#889999,#4499DD,#DDDDDD,#AACCCC","#27282D,#474D4B,#F54296,#E0F635,#FDFFF7","#294052,#447294,#8FBCDB,#F4D6BC,#F8E4CC","#886655,#DD9977,#EECCAA,#EEEEEE,#CC99CC","#070A1E,#382230,#58423F,#888069,#C1BF95","#553333,#99aaaa,#998866,#cccc99,#aabbaa","#223333,#889999,#dd9988,#ddeedd,#bbcccc","#332244,#bb3355,#998899,#ff5555,#ffdd99","#FF6600,#F6F6EF,#828282,#000000","#2B2B2D,#166622,#2FBB4F,#922729","#332244,#5566aa,#aa7799,#dd9999,#ffdd99","#334444,#99aa88,#bbbbaa,#ddddcc,#ccccbb","#444466,#6666aa,#8888aa,#8877dd,#ccbbff","#4D90FE,#DD4B39,#F1F1F1,#777777","#555588,#6688DD,#FFEEFF,#DDCCEE,#BBBBDD","#3366BB,#CCCCCC,#EEEEEE,#DDDDEE,#FFDD11","#443344,#aa5555,#668899,#dd8855,#cccccc","#333355,#4455aa,#997777,#5577dd,#dd9977","#E96F23,#EC8B26,#ECB842,#6796B8,#5C556A"]})
I.$lazy($,"ctx","Ee","H9",function(){var z=H.Go(document.querySelector("#canvas"),"$isNy")
z.toString
return z.getContext("2d")})

init.functionAliases={}
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Vv",ret:J.kn,args:[W.cv,J.O,J.O,W.JQ]},{func:"WW",void:true,args:[W.ea]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"KV",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"YI",void:true,args:[P.a]},{func:"qu",void:true,args:[W.KV]},{func:"c0",args:[W.HL]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
QA.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,P2,nB,i3,it,QP,IF,n6,Ny,Kh,TK,Y5,Gc,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,ae,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,PP,Qb,PG,xe,Hw,bn,Ik,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,u2,bX,lr,MC,iQ,Ue,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,YS,y6,RH,Kn,Lq,w6,BR,vw,aG,J6,Oi,UM,hq,WS,NL,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,um,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,jr,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Dc,Sl,Qm,ET,V6,FK,Gv,kn,YE,MF,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,Eq,lb,tD,hJ,dC,wN,VX,aL,a7,i1,xy,MH,A8,U5,SO,SU,Ca,vs,da,xw,dm,rq,RW,RT,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,iP,Hn,Zl,UT,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,oe,kM,An,c8,a,mE,Rn,wv,M0,VG,Cv,zL,ec,e7,dx,kE,hm,x5,cf,i7,I2,RO,eu,xC,JQ,Pb,vD,mD,Eg,m6,ct,tE,Ow,W9,dW,rB,kF,mk,MM,fm,IU,mg,b0,Pg,Ob,GV,D7,Zf,GS,em,Lb,QA]}